    ...
    defaultConfig {
        ...
        externalNativeBuild {
            cmake {
                ...
                // Tensor G4 (Pixel 9 Pro): ARMv9 with dotprod, i8mm, fp16, sve
                cppFlags("-std=c++17 -march=armv8.6-a+dotprod+i8mm+fp16+sve")
                cFlags("-march=armv8.6-a+dotprod+i8mm+fp16+sve")
            }
        }
    }
